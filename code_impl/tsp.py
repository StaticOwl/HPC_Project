...
def parse_arguments():
    ...
    parser.add_argument('--type', default='serial', choices=['serial', 'parallel'],
                        help='Execution type (serial or parallel)')
    parser.add_argument('--algo', default='held_karp', choices=['held_karp', 'two_opt', 'brute_force', 'genetic'],
    ...
    parser.add_argument('--num_threads', default=64, type=int,
                        help='Number of threads to use (applicable in parallel mode)')
